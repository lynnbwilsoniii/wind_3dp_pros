...
;;----------------------------------------------------------------------------------------
;;  There are 907474 total data points
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  |∂B| [nT, in SCF and NCB basis]  For 907470 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     9.7204328e-05       10.011547      0.20885684      0.41650029   0.00043721914
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  |∂E| [mV/m, in NIF and NCB basis]  For 907186 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;       0.014981170       298.93043       12.039908       17.502084     0.018375603
;;----------------------------------------------------------------------------------------
...
;;----------------------------------------------------------------------------------------
;;  |-(∂E . j)| [µW m^(-3), in NIF and NCB basis]  For 907186 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     2.8516200e-11       3.9782300     0.014166562     0.061191662   6.4245702e-05
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  *nu* [W-P collision frequency, IAWs, rad/s, in NIF and NCB basis]  For 907087 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     2.3154800e-06       2483.9400       5.1515805       30.565135     0.032092374
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  *eta* [W-P resistivity, IAWs, Ω m, in NIF and NCB basis]  For 907087 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     3.1188700e-05       9378.0300       15.858031       107.23434      0.11259249
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  (*eta* |j|^2) [W-P resistivity, IAWs, µW m^(-3), in NIF and NCB basis]  For 907087 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     1.0800000e-15       1.1249500   0.00040303000    0.0073320728   7.6984323e-06
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  |∂B|/<Bo>_{up}  [unitless, SCM in SCF and NCB basis]  For 907470 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     4.7442600e-05       1.4458600     0.026734706     0.038285927   4.0190464e-05
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  |Bo|/<Bo>_{up}  [unitless, FGM in SCF and NCB basis]  For 907474 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;        0.19169145       22.824451       4.6306912       3.3820041    0.0035502345
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  |∂B|^2/(2 µ_o)  [µW m^(-3), SCM in SCF and NCB basis]  For 907470 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     3.7595109e-15   3.9880680e-05   8.6378751e-08   6.1067140e-07   6.4104932e-10
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  |∂E|/(c <Bo>_{up})  [unitless, EFI in NIF and NCB basis]  For 907186 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     3.6605300e-05       1.0934600    0.0091977927     0.018481321   1.9403713e-05
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  ∑_o |∂E|^2/2 [µW m^(-3), EFI in NIF and NCB basis]  For 907186 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     9.9359678e-16   3.9560247e-07   1.9978678e-09   9.4274756e-09   9.8979953e-12
;;----------------------------------------------------------------------------------------
...
;;----------------------------------------------------------------------------------------
;;  § = (*eta* |j|^2)/∆¥  [unitless (from enthalpy), EFI in NIF and NCB basis]  For 907087 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     2.0359020e-13       20195.759       5.5728145       110.12946      0.11563226
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  £ = (*eta* |j|^2)/∆∑  [unitless (from entropy), EFI in NIF and NCB basis]  For 907087 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     2.7609246e-12       129373.94       33.231714       701.30885      0.73635094
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  ‡ = |(∂E . j)|/∆¥  [unitless (from enthalpy), EFI in NIF and NCB basis]  For 907186 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     3.6805225e-06       59122.347       177.72297       840.01406      0.88193867
;;----------------------------------------------------------------------------------------

;;----------------------------------------------------------------------------------------
;;  € = |(∂E . j)|/∆∑  [unitless (from entropy), EFI in NIF and NCB basis]  For 907186 points
;;----------------------------------------------------------------------------------------
;;            Min             Max            Mean          Std. Dev.       Std. Dev.
;;                                                                          of Mean
;;========================================================================================
;;     1.1029653e-05       378737.49       1002.1947       4023.9865       4.2248213
;;----------------------------------------------------------------------------------------
...
;;  Table 3
$\mid$$\delta$\textbf{E}$\mid$ [mV m$^{-1}$]               & 1.50$\times$10$^{-02}$ & 2.99$\times$10$^{+02}$ & 1.20$\times$10$^{+01}$ & 1.75$\times$10$^{+01}$ & 1.84$\times$10$^{-02}$ & 907186  \\
$\mid$$\delta$\textbf{B}$\mid$ [nT]                        & 9.72$\times$10$^{-05}$ & 1.00$\times$10$^{+01}$ & 2.09$\times$10$^{-01}$ & 4.17$\times$10$^{-01}$ & 4.37$\times$10$^{-04}$ & 907470  \\
...
\hline
$\mathfrak{B}$ [unitless]                                  & 4.74$\times$10$^{-05}$ & 1.45$\times$10$^{+00}$ & 2.67$\times$10$^{-02}$ & 3.83$\times$10$^{-02}$ & 4.02$\times$10$^{-05}$ & 907470  \\
$\mathfrak{b}$ [unitless]                                  & 1.92$\times$10$^{-01}$ & 2.28$\times$10$^{+01}$ & 4.63$\times$10$^{+00}$ & 3.38$\times$10$^{+00}$ & 3.55$\times$10$^{-03}$ & 907474  \\
$\mathfrak{E}$ [unitless]                                  & 3.66$\times$10$^{-05}$ & 1.09$\times$10$^{+00}$ & 9.20$\times$10$^{-03}$ & 1.85$\times$10$^{-02}$ & 1.94$\times$10$^{-05}$ & 907186  \\
\hline
$\mathcal{W}{\scriptstyle_{B}}$ [$\mu$W m$^{-3}$]          & 3.76$\times$10$^{-15}$ & 3.99$\times$10$^{-05}$ & 8.64$\times$10$^{-08}$ & 6.11$\times$10$^{-07}$ & 6.41$\times$10$^{-10}$ & 907470  \\
$\mathcal{W}{\scriptstyle_{E}}$ [$\mu$W m$^{-3}$]          & 9.94$\times$10$^{-16}$ & 3.96$\times$10$^{-07}$ & 2.00$\times$10$^{-09}$ & 9.43$\times$10$^{-09}$ & 9.90$\times$10$^{-12}$ & 907186  \\
\hline
$\nu{\scriptstyle_{iaw}}$ [coll. s$^{-1}$]                 & 2.32$\times$10$^{-06}$ & 2.48$\times$10$^{+03}$ & 5.15$\times$10$^{+00}$ & 3.06$\times$10$^{+01}$ & 3.21$\times$10$^{-02}$ & 907087  \\
$\eta{\scriptstyle_{iaw}}$ [$\Omega$ m]                    & 3.12$\times$10$^{-05}$ & 9.38$\times$10$^{+03}$ & 1.59$\times$10$^{+01}$ & 1.07$\times$10$^{+02}$ & 1.13$\times$10$^{-01}$ & 907087  \\
\hline
$\mathfrak{R}{\scriptstyle_{\eta}}$ [$\mu$W m$^{-3}$]      & 2.85$\times$10$^{-11}$ & 3.98$\times$10$^{+00}$ & 1.42$\times$10$^{-02}$ & 6.12$\times$10$^{-02}$ & 6.42$\times$10$^{-05}$ & 907186  \\
$\mathcal{S}{\scriptstyle_{\eta}}$ [$\mu$W m$^{-3}$]       & 1.08$\times$10$^{-15}$ & 1.12$\times$10$^{+00}$ & 4.03$\times$10$^{-04}$ & 7.33$\times$10$^{-03}$ & 7.70$\times$10$^{-06}$ & 907087  \\
\hline
$\mathcal{Y}{\scriptstyle_{\Psi}}$ [unitless]              & 2.76$\times$10$^{-12}$ & 1.29$\times$10$^{+05}$ & 3.32$\times$10$^{+01}$ & 7.01$\times$10$^{+02}$ & 7.36$\times$10$^{-01}$ & 907087  \\
$\mathcal{R}{\scriptstyle_{\Psi}}$ [unitless]              & 1.10$\times$10$^{-05}$ & 3.79$\times$10$^{+05}$ & 1.00$\times$10$^{+03}$ & 4.02$\times$10$^{+03}$ & 4.22$\times$10$^{+00}$ & 907186  \\
...
;;=================================================================================================================================
;;      152.465      95.411     776.692      10.013     926.852      69.170      87.667       1.847       9.906      17.904      47.103
;;       25.515     124.203     300.904      17.614    1105.503      14.195      48.249     106.099      17.501      18.873      32.681
;;        4.738      26.480      77.693       4.885     241.240       4.280      12.458      28.356       2.553       3.390       6.176
;;---------------------------------------------------------------------------------------------------------------------------------
