...
tbow0          = time_double(tdate[0]+'/'+['15:50:00','15:55:00'])
good_i0        = WHERE(i_time0 GE tbow0[0] AND i_time1 LE tbow0[1],gdi0)
PRINT,';;', gdi0
;;          97
  ...
  FOR k=0L, 2L DO BEGIN                                                          $
    popen,fnames[j,k],/PORT                                                    & $
      contour_3d_1plane,dat_0,vec1,vec2,VLIM=vlim,NGRID=ngrid,XNAME=xname,       $
                            ...
                            EX_VN1=sunn[0],EX_VEC0=gnorm,EX_VN0=normnm[0],       $
                            SM_CONT=smct,/NO_REDF,INTERP=0,DFMIN=dfmin[0],       $
                            DFMAX=dfmax[0]                                     & $
    pclose

;; # Bash commands
mv IESA_THA_*_V1_vs_V1xV2_* ../TPLOT_THEMIS_PLOTS/esa_contours/2009-09-26/THEMIS_B/IESA_Burst_DF/Plane_V1_vs_V1xV2/
mv IESA_THA_*_V1xV2_vs_V1xV2xV1_* ../TPLOT_THEMIS_PLOTS/esa_contours/2009-09-26/THEMIS_B/IESA_Burst_DF/Plane_V1xV2_vs_V1xV2xV1/
mv IESA_THA_*_V1xV2xV1_vs_V1_* ../TPLOT_THEMIS_PLOTS/esa_contours/2009-09-26/THEMIS_B/IESA_Burst_DF/Plane_V1xV2xV1_vs_V1/
