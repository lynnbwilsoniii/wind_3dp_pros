...
WSET,0
  ...
  time_bar,traz,COLOR=250

;;  Shock overview
coord          = coord_gse[0]
fgm_mode       = 1L      ;;  fgl
all_fgm_tpnm   = fgm_all_out.(1)[fgm_mode[0]]
nna            = [all_fgm_tpnm,Te_Ti_tpn,Ni__tpnm,Vi__tpnm]
f_pref         = prefu[0]+coord[0]+'-All_'+mode_fgm[fgm_mode[0]]+'-mag-vec_Te-Ti_'+t_fac_str[0]+'_Ni_Vbulk_'
;trange         = tra_overview
trange         = tra_overview2
tlimit,trange
tra_zooms      = {T0:tra_efp_0,T1:tra_efw_0}
...
fname0         = f_pref[0]+ftime[0]+'_zoom-to_'
...
FOR j=0L, 1L DO BEGIN                                                         $
  traz = tra_zooms.(j)                                                      & $
  fnm_trz = file_name_times(traz,PREC=4)                                    & $
  fzoom   = STRMID(fnm_trz.F_TIME[0],11L)+'-'+STRMID(fnm_trz.F_TIME[1],11L) & $
  fnames  = fname0[0]+fzoom[0]                                              & $
  popen,fnames[0],/PORT                                                     & $
    tplot,nna,TRANGE=trange                                                 & $
    time_bar,traz,COLOR=250                                                 & $
  pclose                                                                    & $
...
fgm_mode       = 2L      ;;  fgh
all_fgm_tpnm   = fgm_all_out.(1)[fgm_mode[0]]
nna            = [all_fgm_tpnm,efp_dsl_orig[0],efp_dsl_nospk[0],efp_spinfitmod[0],efp_rmspft_dsl[0]]
f_pref         = prefu[0]+coord[0]+'-All_'+mode_fgm[fgm_mode[0]]+'_efp-cal-despike_efp-spinfitmodel_efp-rmDCoff-despin_'
traz           = tra_efw_0
fnm_tra        = file_name_times(trange,PREC=4)
ftime          = fnm_tra.F_TIME[0]+'-'+STRMID(fnm_tra.F_TIME[1],11L)  ;; e.g., 2009-07-13_0859x41.8650-0859x51.8650
...
;;  Plot (-Jo . E) and its cumulative sum
trange         = tra_efw_0
coord          = coord_ncb[0]
fgm_mode       = 2L      ;;  fgh
all_fgm_tpnm   = fgm_all_out.(1)[fgm_mode[0]]
...
all_fgm_tpnm   = fgm_all_out.(1)[fgm_mode[0]]
f_pref0        = prefu[0]+coord[0]+'-All_'+mode_fgm[fgm_mode[0]]
f_pref         = f_pref0[0]+'_Jo-US_efp-cal-despike-rmDCoff-despin_efw-cal-DS_JodEoCS_JoddECS_'
Jo_names       = jdECS_tpns
nna            = [all_fgm_tpnm,jvec_name_US[0],ef_names,Jo_names]
fnm_tra        = file_name_times(trange,PREC=4)
ftime          = fnm_tra.F_TIME[0]+'-'+STRMID(fnm_tra.F_TIME[1],11L)  ;; e.g., 2009-07-13_0859x41.8650-0859x51.8650
