...
options,db_bom_mag_tpn[0],COLORS=vec_col[[2,1]],YTITLE=db_bom_mag_ytt[0],YLOG=1,YMINOR=9,YRANGE=yran_db_bom_mag,/DEF
options,db_bov_gse_tpn[0],COLORS=vec_col,   YTITLE=db_bov_gse_ytt[0],LABELS=vec_str,YMINOR=4,/DEF
options,db_bom_gse_tpn[0],COLORS=vec_col,   YTITLE=db_bom_gse_ytt[0],LABELS=vec_str,YMINOR=4,/DEF

;;  Plot results
nna            = [magf__tpn,vbulk_tpn[0],densi_tpn[0],eitem_tpn,mach_tpn[0],all_dB_Bo_tpns]
tplot,nna

nna            = [magf__tpn,vbulk_tpn[0],densi_tpn[0],eitem_tpn,mach_tpn[0],all_dB_Bo_tpns[1:2]]
tplot,nna
...
nna            = [magf__tpn[0:1],mach_tpn[0],all_gd_tpns,all_dB_Bo_tpns[1:2]]
tplot,nna,TRANGE=tra_eVDFs
