...
;;  Define parameters
IF (tdate[0] EQ '2008-07-14') THEN tstart = time_double(tdate[0]+'/14:59:00.000')
...
IF (tdate[0] EQ '2008-07-14') THEN start_t = time_double(tdate[0]+'/'+['14:59','20:03','21:57','23:25']+':00.000') - 6d1*2d0
IF (tdate[0] EQ '2008-07-14') THEN end___t = time_double(tdate[0]+'/'+['15:01','20:05','21:59','23:27']+':00.000') + 6d1*2d0
IF (tdate[0] EQ '2008-08-12') THEN start_t = time_double(tdate[0]+'/'+['01:05']+':00.000') - 6d1*2d0
IF (tdate[0] EQ '2008-08-12') THEN end___t = time_double(tdate[0]+'/'+['01:07']+':00.000') + 6d1*2d0
IF (tdate[0] EQ '2008-08-19') THEN start_t = time_double(tdate[0]+'/'+['07:53','12:49','23:38']+':00.000') - 6d1*2d0
IF (tdate[0] EQ '2008-08-19') THEN end___t = time_double(tdate[0]+'/'+['07:55','12:51','23:40']+':00.000') + 6d1*2d0
IF (tdate[0] EQ '2008-09-08') THEN start_t = time_double(tdate[0]+'/'+['10:56','17:01','20:26']+':00.000') - 6d1*2d0
IF (tdate[0] EQ '2008-09-08') THEN end___t = time_double(tdate[0]+'/'+['10:58','17:03','20:28']+':00.000') + 6d1*2d0
IF (N_ELEMENTS(start_t) EQ 1) THEN all_st  = [start_t,fgh_st] ELSE all_st  = fgh_st
IF (N_ELEMENTS(end___t) EQ 1) THEN all_en  = [end___t,fgh_en] ELSE all_en  = fgh_en
...
new_dir        = cur_wdir[0]+'eVDF_Fits_'+tdate[0]+slash[0]
