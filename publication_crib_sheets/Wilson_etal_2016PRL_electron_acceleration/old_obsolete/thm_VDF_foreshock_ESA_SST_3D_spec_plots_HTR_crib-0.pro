...
FOR j=0L, n_esae[0] - 1L DO dt_esae[*,*,j] = dat0[j].INTEG_T[0]*dat0[j].DT
...
;;----------------------------------------------------------------------------------------
;FOR j=0L, n_esae[0] - 1L DO str_element,dat0[j],'VSW',dat0[j].VELOCITY,/ADD_REPLACE
;FOR j=0L, n_sste[0] - 1L DO str_element,dat1[j],'VSW',dat1[j].VELOCITY,/ADD_REPLACE
;FOR j=0L, n_ssti[0] - 1L DO str_element,dat2[j],'VSW',dat2[j].VELOCITY,/ADD_REPLACE
