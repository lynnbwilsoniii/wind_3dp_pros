...
options,thm_bsntpn2[0],YRANGE=[0e0,9e1],YTICKV=LINDGEN(7)*15e0,YTICKS=6,YMINOR=4,/DEF
options,thm_bsntpn2[0],YGRIDSTYLE=2,YTICKLEN=1e0
...
Mlabs          = ['M_A','M_s','M_f']
Mcols          = vec_col
options,thm_Machs_tpn[0],YTITLE='Mach #s',YSUBTITLE='[Using (Vi . n)]',COLORS=mcols,$
                         LABELS=mlabs,YRANGE=machran,YTICKV=mach_tv,YTICKS=mach_ts, $
                         YMINOR=4,/DEF
options,thm_Machs_tpn[0],YGRIDSTYLE=2,YTICKLEN=1e0
