...
FOR frame=0L, 1L DO BEGIN                                                                  $
  ...
  FOR k=0L, 0L DO BEGIN                                                                    $
    ...
    FOR j=0L, gnne[0] - 1L DO BEGIN                                                        $
      ...
      temp = wrapper_evdf_fits_para_perp_anti(dat0,_EXTRA=extr)                          & $
...
FOR frame=0L, 1L DO BEGIN                                            $
  FOR j=0L, gnne[0] - 1L DO BEGIN                                    $
    PTR_FREE,pl_fit_pnt[j,frame]                                   & $
    HEAP_FREE,pl_fit_pnt[j,frame],/PTR
DELVAR,pl_fit_pnt
...
FOR frame=0L, 1L DO BEGIN                                            $
  FOR j=0L, gnne[0] - 1L DO BEGIN                                    $
    PTR_FREE,exp_fit_pnt[j,frame]                                  & $
    HEAP_FREE,exp_fit_pnt[j,frame],/PTR
DELVAR,exp_fit_pnt
