...
;*****************************************************************************************
;
;  FUNCTION :   core_kk_halo_kk_fit.pro
;  PURPOSE  :   Creates a velocity distribution function (VDF) that is constructed from
;                 the superposition of two VDFs, one for the cold, core (bi-kappa)
;                 and one for the hot, halo (bi-kappa) particles.
;
;  CALLED BY:   
;               NA
;
...
;  EXAMPLES:    
;               [calling sequence]
;               cmmhkk = core_kk_halo_kk_fit(vpara, vperp, param, pder [,FF=ff] )
;
;  KEYWORDS:    
...
FUNCTION core_kk_halo_kk_fit,vpara,vperp,param,pder,FF=ff
...
;;----------------------------------------------------------------------------------------
ff             = core_halo_superpos_fit(vpara,vperp,param,pder,FF=ff,CFUNC='KK',HFUNC='KK')
;;----------------------------------------------------------------------------------------
