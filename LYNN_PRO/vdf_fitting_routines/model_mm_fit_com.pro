...
;
;               P_MM_FAC  :  [6]-Element [numeric] array of multiplication factors, where
;                              each element is defined by the following quantities:
;                              P_MM_FAC[0] = Number Density [cm^(-3)]
;                              P_MM_FAC[1] = Parallel Thermal Speed [km/s]
;                              P_MM_FAC[2] = Perpendicular Thermal Speed [km/s]
;                              P_MM_FAC[3] = Parallel Drift Speed [km/s]
;                              P_MM_FAC[4] = Perpendicular Drift Speed [km/s]
;                              P_MM_FAC[5] = 1 (i.e., Maxwellian velocity exponent)
;                                            {Note:  not allowed to vary}
;               INIT_YMM  :  Scalar [boolean] defining whether the P_MM_FAC values have
;                              been initialized
;                              [Default = FALSE]
;
;   CHANGED:  1)  NA
...
COMMON model_mm_fit_com,p_mm_fac,init_ymm
