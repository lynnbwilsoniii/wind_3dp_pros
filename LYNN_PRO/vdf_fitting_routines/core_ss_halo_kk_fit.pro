...
;*****************************************************************************************
;
;  FUNCTION :   core_ss_halo_kk_fit.pro
;  PURPOSE  :   Creates a velocity distribution function (VDF) that is constructed from
;                 the superposition of two VDFs, one for the cold, core (bi-self-similar)
...
;  EXAMPLES:    
;               [calling sequence]
;               cmmhkk = core_ss_halo_kk_fit(vpara, vperp, param, pder [,FF=ff] )
;
;  KEYWORDS:    
...
FUNCTION core_ss_halo_kk_fit,vpara,vperp,param,pder,FF=ff
...
;;----------------------------------------------------------------------------------------
ff             = core_halo_superpos_fit(vpara,vperp,param,pder,FF=ff,CFUNC='SS',HFUNC='KK')
;;----------------------------------------------------------------------------------------
