...
;
;               P_SS_FAC  :  [6]-Element [numeric] array of multiplication factors, where
;                              each element is defined by the following quantities:
;                              P_SS_FAC[0] = Number Density [cm^(-3)]
;                              P_SS_FAC[1] = Parallel Thermal Speed [km/s]
;                              P_SS_FAC[2] = Perpendicular Thermal Speed [km/s]
;                              P_SS_FAC[3] = Parallel Drift Speed [km/s]
;                              P_SS_FAC[4] = Perpendicular Drift Speed [km/s]
;                              P_SS_FAC[5] = Self-Similar Exponent Value [only values ≥ 2]
;                                            {Note:  s = 2 --> bi-Maxwellian}
;               INIT_YSS  :  Scalar [boolean] defining whether the P_SS_FAC values have
;                              been initialized
;                              [Default = FALSE]
;
;   CHANGED:  1)  NA
...
COMMON model_ss_fit_com,p_ss_fac,init_yss
