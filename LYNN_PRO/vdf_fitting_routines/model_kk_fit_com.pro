...
;
;               P_KK_FAC  :  [6]-Element [numeric] array of multiplication factors, where
;                              each element is defined by the following quantities:
;                              P_KK_FAC[0] = Number Density [cm^(-3)]
;                              P_KK_FAC[1] = Parallel Thermal Speed [km/s]
;                              P_KK_FAC[2] = Perpendicular Thermal Speed [km/s]
;                              P_KK_FAC[3] = Parallel Drift Speed [km/s]
;                              P_KK_FAC[4] = Perpendicular Drift Speed [km/s]
;                              P_KK_FAC[5] = Kappa Value
;                                            {Note:  kappa = Infinity --> bi-Maxwellian}
;               INIT_YKK  :  Scalar [boolean] defining whether the P_KK_FAC values have
;                              been initialized
;                              [Default = FALSE]
;
;   CHANGED:  1)  NA
...
COMMON model_kk_fit_com,p_kk_fac,init_ykk
