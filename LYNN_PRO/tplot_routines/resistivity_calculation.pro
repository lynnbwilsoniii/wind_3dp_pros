...
;             2)  Fixed typo in structure tag names                 [04/26/2012   v1.1.0]
;
;   NOTES:      
...
;    LAST MODIFIED:  04/26/2012   v1.1.0
...
;-----------------------------------------------------------------------------------------
;-----------------------------------------------------------------------------------------
; => Define anomalous resistivity due to LHDI [Coroniti, 1985]
;-----------------------------------------------------------------------------------------
;-----------------------------------------------------------------------------------------
...
;;  add results to output structure
str_element,struct_out,'LHDI_COLL_FREQ_C1985',lhd_c_freq,/ADD_REPLACE
str_element,struct_out,'LHDI_RESISTIVITY_C1985',lhd_c_resist,/ADD_REPLACE
...
;;  add results to output structure
str_element,struct_out,'LHDI_COLL_FREQ_LT1988',lhdi_c_freq,/ADD_REPLACE
str_element,struct_out,'LHDI_RESISTIVITY_LT1988',lhdi_c_resist,/ADD_REPLACE
;-----------------------------------------------------------------------------------------
...
;;  add results to output structure
str_element,struct_out,'ECDI_COLL_FREQ_LT1988',ecdi_c_freq,/ADD_REPLACE
str_element,struct_out,'ECDI_RESISTIVITY_LT1988',ecdi_c_resist,/ADD_REPLACE
...
;;  add results to output structure
str_element,struct_out,'MTSI_COLL_FREQ_LT1988',mtsi_c_freq,/ADD_REPLACE
str_element,struct_out,'MTSI_RESISTIVITY_LT1988',mtsi_c_resist,/ADD_REPLACE
