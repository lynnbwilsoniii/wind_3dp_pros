...
;  EXAMPLES:    
;               [calling sequence]
;               rotate_3dp_structure, dat, vector1, vector2 [,VLIM=vlim] [,C_LOG=c_log] $
;                                          [,TGRID=tgrid] [,SLICE2D=slice2d]
;
;               ;;....................................................................
...
;               C_LOG      :  If set, routine will compute the VDF in logarithmic
...
;                   energy_to_vel.pro instead of velocity.pro
;                                                                   [05/24/2012   v1.2.0]
...
;                                                                   [12/04/2015   v1.5.1]
;             7)  Added keywords: C_LOG, TGRID, and SLICE2D
;                                                                   [05/27/2017   v1.6.0]
;
;   NOTES:      
;               0)  Definitions
...
;    LAST MODIFIED:  05/27/2017   v1.6.0
;    MODIFIED BY: Lynn B. Wilson III
;
;*****************************************************************************************
;-

PRO rotate_3dp_structure,dat,vector1,vector2,VLIM=vlim,C_LOG=c_log,TGRID=tgrid,$
                                             SLICE2D=slice2d
...
;;----------------------------------------------------------------------------------------
IF (clog_on[0]) THEN dat_1d = ALOG10(REFORM(df_dat,n_e[0]*n_a[0])) ELSE dat_1d = REFORM(df_dat,n_e[0]*n_a[0])
;dat_1d         = REFORM(df_dat,n_e*n_a)
ener_1d        = REFORM(energy,n_e[0]*n_a[0])
phi_1d         = REFORM(phi,n_e[0]*n_a[0])
the_1d         = REFORM(the,n_e[0]*n_a[0])
...
;;----------------------------------------------------------------------------------------
r_vels         = rotate_and_triangulate_dfs(swfv,dat_1d,rotm,rotz,VLIM=vlim[0], $
                                            C_LOG=clog_on[0],NGRID=ntg[0],      $
                                            SLICE2D=slice_on[0])
