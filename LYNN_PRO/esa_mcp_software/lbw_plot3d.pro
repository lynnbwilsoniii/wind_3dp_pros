...
;                                                                   [03/21/2009   v1.1.0]
;             3)  Fixed a syntax error
;                                                                   [03/22/2009   v1.1.1]
;             4)  Fixed triangulation issue
;                                                                   [03/22/2009   v1.1.2]
...
;                   and changed plot titles a little
;                                                                   [09/03/2009   v1.3.2]
;            11)  Added keyword:  ONE_ZRA
;                                                                   [09/03/2009   v1.4.0]
;            12)  Changed font sizes and X-Margins
;                                                                   [09/24/2009   v1.4.1]
...
;                   and fixed neglected issue with ZRANGE
;                                                                   [09/26/2009   v1.6.0]
;            16)  Added program:  sst_foil_bad_bins.pro
;                                                                   [02/13/2010   v1.7.0]
;            17)  Added keyword:  KILL_SMGF
;                                                                   [02/25/2010   v1.8.0]
...
;                   REPLICATE(!VALUES.F_NAN,3)
;                                                                   [11/01/2010   v1.8.2]
;            20)  Fixed issue with SUM_EBINS keyword when set not equal to 1
;                                                                   [12/07/2011   v1.8.3]
;            21)  Changed auto Z-range calculation
;                                                                   [01/12/2012   v1.8.4]
;            22)  Changed name to lbw_plot3d.pro from plot3d.pro and moved to LYNN_PRO
;                                                                   [08/04/2016   v2.0.0]
;
;   NOTES:      
...
;    LAST MODIFIED:  08/04/2016   v2.0.0
;    MODIFIED BY: Lynn B. Wilson III
;
;*****************************************************************************************
;-

PRO lbw_plot3d,tbindata,latitude,longitude,                                      $
