...
;*****************************************************************************************
;
;  FUNCTION :   calc_velmoms_with_uncer_from_pois.pro
...
;  EXAMPLES:    
;               [calling sequence]
;               test = calc_velmoms_with_uncer_from_pois(vels,data,pois [,VLIM=vlim] $
...
FUNCTION calc_velmoms_with_uncer_from_pois,vels,data,pois,VLIM=vlim,NGRID=ngrid,    $
...
;;  Integrate f(v) ± ∂f(v)
;;----------------------------------------------------------------------------------------
fmdf_moms      = lbw_nintegrate_3d_vdf(vxyz,f_m_df,VLIM=vlim,NGRID=ngrid,SLICE2D=slice2d,$
...
fofv_moms      = lbw_nintegrate_3d_vdf(vxyz,f_of_v,VLIM=vlim,NGRID=ngrid,SLICE2D=slice2d,$
                                       VFRAME=vframe,ELECTRON=electron,PROTON=proton,    $
                                       ALPHA_P=alpha_p,MAG_DIR=mag_dir,VEC1=vec1,        $
                                       VEC2=vec2)
...
fpdf_moms      = lbw_nintegrate_3d_vdf(vxyz,f_p_df,VLIM=vlim,NGRID=ngrid,SLICE2D=slice2d,$
                                       VFRAME=vframe,ELECTRON=electron,PROTON=proton,    $
                                       ALPHA_P=alpha_p,MAG_DIR=mag_dir,VEC1=vec1,        $
                                       VEC2=vec2)
