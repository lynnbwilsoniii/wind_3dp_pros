...
;*****************************************************************************************
;
;  FUNCTION :   core_bm_halo_kk_fit.pro
...
;  EXAMPLES:    
;               [calling sequence]
;               cmmhkk = core_bm_halo_kk_fit(vpara, vperp, param, pder [,FF=ff] )
;
;  KEYWORDS:    
...
FUNCTION core_bm_halo_kk_fit,vpara,vperp,param,pder,FF=ff
...
;;----------------------------------------------------------------------------------------
ff             = core_halo_superpos_fit(vpara,vperp,param,pder,FF=ff,CFUNC='MM',HFUNC='KK')
;;----------------------------------------------------------------------------------------
