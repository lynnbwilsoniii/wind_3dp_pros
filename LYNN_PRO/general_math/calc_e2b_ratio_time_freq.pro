...
;*****************************************************************************************
;
;  FUNCTION :   calc_e2b_ratio_time_freq.pro
...
;
;  EXAMPLES:    
;               test   = calc_e2b_ratio_time_freq(tt,ef,bf,WIDTH=wd,/RM_EDGE,      $
...
;                                                                   [07/10/2015   v1.0.0]
;             6)  Changed name from temp_calc_e2b_ratio_freq.pro to
;                   calc_e2b_ratio_time_freq.pro
;                                                                   [08/12/2015   v1.1.0]
;
;   NOTES:      
;               1)  # of vectors must satisfy:  N ≥ 128
;               2)  I am still ironing out some thoughts about the validity of some
;                     of the algorithms and methods herein, so use with caution...
;
;  REFERENCES:  
...
FUNCTION calc_e2b_ratio_time_freq,tt,ef,bf,WIDTH=width,RM_EDGE=rm_edge,SRATE=srate,$
                                  FLOW=flow,FHIGH=fhigh,NFFT=nfft,NSHFT=nshft

;;  Let IDL know that the following are functions
FORWARD_FUNCTION is_a_number, format_2d_vec, sample_rate, vector_bandpass, mag__vec, $
                 my_crossp_2, time_and_freq_averaged_fft, power_of_2
;;----------------------------------------------------------------------------------------
