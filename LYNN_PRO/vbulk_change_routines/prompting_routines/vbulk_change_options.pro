...
;                                                                   [07/28/2017   v1.0.0]
;             6)  Fixed an indexing issue when reforming an array
;                                                                   [05/26/2021   v1.0.1]
;
;   TO DO LIST: 
;               *****************************************************
...
;    LAST MODIFIED:  05/26/2021   v1.0.1
...
;      se_t           = REFORM(vdf_info.SE_T,n_vdfi[0],2L)
      se_t           = REPLICATE(0d0,n_vdfi[0],2L)
      se_t[*,0]      = vdf_info.SE_T[0]
      se_t[*,1]      = vdf_info.SE_T[1]
      s_times        = se_t[*,0]
      e_times        = se_t[*,1]
      PRINT,';;'
