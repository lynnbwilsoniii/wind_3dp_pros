...
;  EXAMPLES:    
;               [calling sequence]
;               wrapper_vbulk_change_thm_wi, data [,DFRA_IN=dfra_in] [,EX_VECN=ex_vecn] $
;                                            [,VCIRC=vcirc] [,VC_XOFF=vc_xoff]          $
;                                            [,VC_YOFF=vc_yoff] [,STRUC_OUT=struc_out]
;
;  KEYWORDS:    
;               ***  INPUT  ***
...
sav_dir        = cwd_char[0]+t_pref[0]+tdate[0]
;;  Define plot titles
...
cont_out       = REPLICATE(cont_str[0],ndat[0])
;;----------------------------------------------------------------------------------------
;;  Start Loop
;;----------------------------------------------------------------------------------------
