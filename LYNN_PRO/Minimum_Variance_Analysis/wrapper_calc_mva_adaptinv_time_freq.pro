...
;*****************************************************************************************
;
;  FUNCTION :   wrapper_calc_mva_adaptinv_time_freq.pro
...
;                 then calls the adaptive interval MVA software.
;
;  CALLED BY:   
;               NA
;
...
;  EXAMPLES:    
;               [calling sequence]
;               mva_str = wrapper_calc_mva_adaptinv_time_freq(tpn_magf,tran_se,filt_frq [,TRAN_CLIP=tran_clip])
;
;  KEYWORDS:    
...
;                                                                   [11/11/2022   v1.0.0]
;             4)  Finished writing routine
;                                                                   [11/11/2022   v1.0.0]
;
;   NOTES:      
;               0)  ***  Still a testing routine  ***
...
FUNCTION wrapper_calc_mva_adaptinv_time_freq,tpn_magf,tran_se,filt_frq,TRAN_CLIP=tran_clip
