...
;    LAST MODIFIED:  04/19/2018   v1.0.2
...
FORWARD_FUNCTION is_a_number, is_a_3vector, unit_vec, my_dot_prod, my_crossp_2, $
                 mag__vec, vm_matrix
;;----------------------------------------------------------------------------------------
;;  Constants
;;----------------------------------------------------------------------------------------
...
test           = (is_a_3_vector(av,V_OUT=av_2d,/NOMSSG) EQ 0) OR  $
                 (is_a_3_vector(bv,V_OUT=bv_2d,/NOMSSG) EQ 0)
IF (test[0]) THEN BEGIN
...
ENDIF ELSE BEGIN
  ...
  ENDIF ELSE BEGIN
    ;;------------------------------------------------------------------------------------
    ;;  Only one is an [N,3]-element array where N > 1
    ;;------------------------------------------------------------------------------------
