...
;                   input function
;                                                                   [10/31/2020   v1.1.0]
;             2)  Fixed several issues including correcting some errors in the
;                   input function
;                                                                   [11/02/2020   v1.2.0]
;
;   NOTES:      
...
;    LAST MODIFIED:  11/02/2020   v1.2.0
...
;;----------------------------------------------------------------------------------------
;;  Calculate function
;;    Y = PARAM[0]*PARAM[1]^3*EXP(-(X - PARAM[2])/(bo*PARAM[1]^2)) + PARAM[3]
;;----------------------------------------------------------------------------------------
...
;;    dY/dA = (Y - D)/A
;;    dY/dB = (Y - D)*[2*(X - C) - 3*bo*B^2]/(bo*B^3)
;;    dY/dC = (Y - D)/(bo*B^2)
;;    dY/dD = 1
;;----------------------------------------------------------------------------------------
IF (N_PARAMS() GT 2) THEN BEGIN
  ...
  pder[*,1]      = (ff - param[3])*(2d0*(xx - param[2]) - 3d0*bo[0]*param[1]^2d0)/(bo[0]*param[1]^3d0)
  pder[*,2]      = (ff - param[3])/(bo[0]*param[1]^2d0)
  pder[*,3]      = 1d0
