...
;*****************************************************************************************
;
;  FUNCTION :   waves_rad_file_read.pro
...
;                           directory path, for WAVES RAD1 or RAD2 ASCII files
;
;  EXAMPLES:    
;               rad_data = waves_rad_file_read(files)
;
;  KEYWORDS:    
;               NA
;
...
;                                                                 [03/11/2011   v1.0.1]
;             2)  Updated man page and changed name to waves_rad_file_read.pro
...
FUNCTION waves_rad_file_read,files
...
nf             = 256L                  ;;  # of total rows per file [ = # of frequencies]
nx             = nfi*(td - 1L)
