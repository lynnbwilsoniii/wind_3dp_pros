...
spdthr                  = [15d-2,20d-2,20d-2]*mnmxsp[1]
IF KEYWORD_SET(electrons) THEN spdthr[0] = spdthr[0] < 4d3
...
;  check                   = [(MAX(cor2zori,/NAN) GT maxfac[0]),(MAX(hal2zori,/NAN) GT maxfac[0]),(MAX(bea2zori,/NAN) GT maxfac[0])]
  bad                     = WHERE(check,bd)
