...
;                                                                  [09/06/2012   v1.2.2]
;             6)  Cleaned up                                       [09/08/2012   v1.2.3]
;             7)  Now uses the square root of the count rate (corrected for deadtime)
;                   for error estimates
;                                                                  [10/09/2012   v1.3.0]
;
;   NOTES:      
...
;   CREATED:  08/21/2012
;   CREATED BY:  Lynn B. Wilson III
;    LAST MODIFIED:  10/09/2012   v1.3.0
;    MODIFIED BY: Lynn B. Wilson III
;
;*****************************************************************************************
;-
