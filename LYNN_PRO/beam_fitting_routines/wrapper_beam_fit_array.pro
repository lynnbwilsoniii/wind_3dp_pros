...
;               NA
;
;   CHANGED:  1)  Fixed header strings
;                                                                  [09/17/2012   v1.1.0]
;             2)  Updated Man. page
;                                                                  [12/04/2015   v1.1.1]
;
...
;    LAST MODIFIED:  12/04/2015   v1.1.1
...
;
;  INPUT:
;               DAT        :  [N]-Element [structure] array of particle velocity
;                               distribution functions (DFs) from either the Wind/3DP
...
;  EXAMPLES:    
;               [calling sequence]
;               wrapper_beam_fit_array,dat [,DFRA_IN=dfra_in] [,EX_VECN=ex_vecn] $
;                                          [,STRUC_OUT=struc_out]
;
;  KEYWORDS:    
;               ***************
...
;   CREATED:  08/25/2012
;   CREATED BY:  Lynn B. Wilson III
;    LAST MODIFIED:  12/04/2015   v1.1.0
;    MODIFIED BY: Lynn B. Wilson III
;
;*****************************************************************************************
;-
...
FORWARD_FUNCTION time_string, beam_fit___get_common, beam_fit_gen_prompt, $
                 beam_fit_test_struct_format, wrapper_beam_fit_header_format
;;----------------------------------------------------------------------------------------
;;  Define some constants and dummy variables
;;----------------------------------------------------------------------------------------
f              = !VALUES.F_NAN
