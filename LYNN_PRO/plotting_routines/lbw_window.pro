...
;    LAST MODIFIED:  02/19/2016   v1.1.0
...
;  test_wopen     = (TOTAL(good_w EQ windn[0]) EQ 0)
...
wxysz          = wsz[0] > wsz[1]
win_ttl        = 'Plots'
;def_win_str    = {RETAIN:2,XSIZE:wxysz[0],YSIZE:wxysz[0],TITLE:win_ttl[0],XPOS:10,YPOS:10}
