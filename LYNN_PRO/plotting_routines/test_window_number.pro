...
;*****************************************************************************************
;
;  FUNCTION :   test_window_number.pro
...
;  EXAMPLES:    
;               [calling sequence]
;               test = test_window_number(windn [,DAT_OUT=dat_out])
;
;  KEYWORDS:    
;               DAT_OUT    :  Set to a named variable to return the actual device
;                               window to use
;                               (should only vary from WINDN if user makes a mistake)
;
;   CHANGED:  1)  NA
;                                                                   [MM/DD/YYYY   v1.0.0]
;
;   NOTES:      
;               1)  This is adapted from vbulk_change_test_windn.pro
;
;  REFERENCES:  
;               NA
;
...
;    LAST MODIFIED:  10/30/2017   v1.0.0
;    MODIFIED BY: Lynn B. Wilson III
;
;*****************************************************************************************
;-

FUNCTION test_window_number,windn,DAT_OUT=dat_out
