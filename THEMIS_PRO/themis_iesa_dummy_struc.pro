...
;*****************************************************************************************
;
;  FUNCTION :   themis_iesa_dummy_struc.pro
;  PURPOSE  :   This routine creates a dummy structure for the THEMIS IESA instrument.
;
;  CALLED BY:   
;               NA
;
...
;
;  EXAMPLES:    
;               ;;  To return the default IESA 3D Burst structure with
;               ;;  [32,88]-[Energy,Angle]-bins, for Probe-A, in units of counts,
;               ;;  with the default unit conversion procedure, then enter the
;               ;;  following:
;               dummy = themis_iesa_dummy_struc()
;               ;;  which is equivalent to the following:
;               dummy = themis_iesa_dummy_struc(PROBE='a',INST_MODE='peeb',          $
...
;                               [Default : 'a']
;               INST_MODE  :  Scalar [string] defining the mode in which the IESA
;                               instrument structure will be defined
;                               [Default : 'peeb']
;                               Accepted string inputs:
;                                 'pei[f,r,b]'  =  for 'IESA 3D [Full,Reduced,Burst]'
...
;
;   NOTES:      
;               1)  Below are the possible instrument modes for IESA
;                    IESA Burst
...
FUNCTION themis_iesa_dummy_struc,PROBE=probe0,INST_MODE=inst_mode0,UNITS=units0,$
