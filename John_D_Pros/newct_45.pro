;   CHANGED:  1)  Altered file path          [02/11/2009   v1.0.1]
;    LAST MODIFIED:  02/11/2009   v1.0.1
;    MODIFIED BY: Lynn B. Wilson III
;
;; Create New Color Table by intepolating between set of defined
;; fixed colors

pro newct_45,tbl_num,tbl_name
...
; fix_val_arr(*,4)=[190,255,0]         ; yellow-green
; fix_val_arr(*,5)=[210,255,0]         ; yellow-green
; fix_val_arr(*,6)=[40,170,50]         ; green
; fix_val_arr(*,7)=[0,110,120]         ; blue-green
; fix_val_arr(*,8)=[30,60,140]         ; blue
; fix_val_arr(*,9)=[40,70,135]         ; blue
; fix_val_arr(*,10)=[70,20,100]         ; purple
; fix_val_arr(*,11)=[100,40,160]        ; bright purple
 
;; (44) Yellow Center Rainbow 
; fix_val_arr(*,0)=[150,0,0]           ; dark red
; fix_val_arr(*,1)=[255,65,0]          ; bright red
; fix_val_arr(*,2)=[255,135,0]         ; orange
; fix_val_arr(*,3)=[255,235,0]         ; yellow
...
;; (45) No Yellow Rainbow + Black
  fix_val_arr(*,0)=[180,0,0]           ; dark red
  fix_val_arr(*,1)=[255,80,0]          ; bright red
  fix_val_arr(*,2)=[240,170,0]         ; orange
  fix_val_arr(*,3)=[180,200,0]         ; yellow-green
  fix_val_arr(*,4)=[40,170,50]         ; green
  fix_val_arr(*,5)=[0,110,120]         ; blue-green
  fix_val_arr(*,6)=[40,30,140]         ; blue
  fix_val_arr(*,7)=[70,20,100]         ; purple
  fix_val_arr(*,8)=[15,0,30]           ; 'black' (purple tint)
...
;; Save new Color Table
  MODIFYCT,tbl_num,tbl_name,rgb_arr[0,*],rgb_arr[1,*],rgb_arr[2,*], $
    FILE='~/Desktop/swidl-0.1/my_colors1.tbl'
