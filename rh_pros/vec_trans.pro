...
;             3)  No longer calls my_crossp_2.pro, now calls vec_2d_cross.pro
;                                                                [07/11/2012   v1.2.0]
;
;   NOTES:      
...
;    LAST MODIFIED:  07/11/2012   v1.2.0
...
ENDIF ELSE BEGIN
  ; => M = N
  ; => v_tt = (n x V)
  nxv   = vec_2d_cross(n1,v1)
  ; =>  v_t = (n x V) x n        [page 357 Eq. 8.22 of Jackson E&M 3rd Edition]
  vt    = vec_2d_cross(nxv,n1)
ENDELSE
;-----------------------------------------------------------------------------------------
