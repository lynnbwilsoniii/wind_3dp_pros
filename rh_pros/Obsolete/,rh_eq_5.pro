...
;*****************************************************************************************
;
;  FUNCTION :   rh_eq_5.pro
;  PURPOSE  :   Computes the normal component momentum flux conservation relation for
;                 an input set of data points and the gradients with respect to the
;                 shock normal angles [azimuthal,poloidal] and the shock speed.
;                 These three variables are free parameters in the minimization of
;                 the merit function defined by the Rankine-Hugoniot equations from
...
FUNCTION rh_eq_5, rho, vsw, mag, tot, phi, the, SIGS=sigs
