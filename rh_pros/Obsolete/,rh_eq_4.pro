...
;*****************************************************************************************
;
;  FUNCTION :   rh_eq_4.pro
;  PURPOSE  :   Computes the transverse electric field conservation relation for an
;                 input set of data points and the gradients with respect to the
...
FUNCTION rh_eq_4, rho, vsw, mag, tot, phi, the, SIGS=sigs
