...
;*****************************************************************************************
;
;  FUNCTION :   rh_eq_6.pro
;  PURPOSE  :   Computes the energy flux conservation relation for an input set of data
;                 points and the gradients with respect to the shock normal angles
;                 [azimuthal,poloidal] and the shock speed.  These three variables are
;                 free parameters in the minimization of the merit function defined by
;                 the Rankine-Hugoniot equations from Koval and Szabo, [2008].
;
;  CALLED BY:   
;               
;
...
FUNCTION rh_eq_6, rho, vsw, mag, tot, phi, the, SIGS=sigs
